...
|     1 | `ADC_PLUGIN_NOT_FOUND`      | Нет плагина для работы с выбранным типом АЦП                      |
|     2 | `ADC_ERROR_CREATING_DEVICE` | Ошибка создания логического устройства                            |
|     3 | `ADC_START_FAILED`          | Ошибка инициализации устройства                                   |
